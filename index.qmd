...
ggplot(data, aes(x = job_category, y = salary_in_usd, fill = job_category)) +
  geom_boxplot() +
...
ggplot(executive_data, aes(x = reorder(job_title, Frequency), y = Frequency, fill = job_title)) +
...
# Stacked area chart
ggplot(summary_data, aes(x = work_year, y = proportion, fill = work_setting)) +
  geom_area(alpha = 0.8) +
